...
const ArtistPage = (props) => {
  ...
  const urlArtists = `${baseUrl}api/ArtistPage`; 
  //const urlSongs = `${baseUrl}api/Song/getall`; 
  const urlSongs = `${baseUrl}api/Event/GetEvents`; 
  const urlEvents = `${baseUrl}api/Event/GetEvents`; 
